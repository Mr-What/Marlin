...
/// #error this is aaron's board section
    ...
    #define Y_MAX_PIN          15//19 // swap YZ due to wiring error : 15

    #define Z_STEP_PIN         46
    #define Z_DIR_PIN          48
    #define Z_ENABLE_PIN       62
    #define Z_MIN_PIN          18 // autolevel for deltabot
    #define Z_MAX_PIN          19//15 // swap YZ due to wiring error : 19
    ...
    #define FAN_PIN            -1// i'm trying to use EXTRUDER0_AUTO_PAN_PIN instead (ab) //9 // (Sprinter config)
  #else
